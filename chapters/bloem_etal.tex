...
{$> 3.5$} & Stress errors & Stress and stress-related \newline errors \vspace{0.1cm} \newline  Fortis/lenis neutralization \vspace{0.1cm} \newline Use of uvular-\textbf{r} \\ \midrule
{$2.2-3.5$} & Stress-related errors \vspace{0.1cm} \newline Fortis/lenis neutralization \vspace{0.1cm} \newline Use of uvular-\textbf{r} \vspace{0.1cm} \newline Some substitutions of /θ,ð/ by /t,d/ \vspace{0.2cm} \newline Glottalisation of final /d/ \vspace{0.1cm} \newline Epenthetic [ə] in /lm/ \vspace{0.1cm} \newline /v $\sim$ w/ confusion \vspace{0.1cm} \newline Confusion of /æ $\sim$ e, ʌ $\sim$ ɒ, ʊ $\sim$ u:/ \vspace{0.1cm} \newline Unaspirated [t] & Most substitutions of /θ,ð/ by /t,d/ \vspace{0.1cm} \newline Glottalisation of final /d/ \vspace{0.1cm} \newline Epenthetic [ə] in /lm/ \vspace{0.1cm} \newline /v $\sim$ w/ confusion \vspace{0.1cm} \newline /æ $\sim$ e/ confusion \vspace{0.1cm} \newline Inappropriate post-vocalic \textbf{r}
\\ 
\lspbottomrule %\midrule
\end{tabular}
