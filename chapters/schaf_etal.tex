...
\ex \textit{Julia backt Kuchen}
 \quein{Julia bakes cake} \label{bsp1}\\
%\\ [b.] 
\ex \textit{Julia braucht Milch, um einen Kuchen zu backen} vs. \textit{}
 \quein{Julia needs milk to bake cake} \label{bsp2}\\
%\item [c.] 
\ex \textit{Oli schl\"aft gerade}
 \quein{Oli is sleeping} \label{bsp3}\\
%\item [d.] 
\ex \textit{Ich weiß nicht, wie sp\"at es ist} \quein{I do not know what time it is} \label{bsp4}\\
\zl
