...
\begin{subfigure}[t]{0.3\textwidth}
\includegraphics[width=\textwidth]{illustrations/pickl_fig15}
\caption{\figref{fig:15}: Factor 16 (0.51~\%).}
\label{fig:15}
\end{subfigure}
\end{figure}
