...
For what concerns the underlying \isi{lexical features}, we first focus on the three main dialectal clusters (A, C and E). \tabref{tab:2} reports for each cluster the five most important CL pairs with associated values of \isi{representativeness}, \isi{distinctiveness} and \isi{importance}.
...
\label{fig:3}\is{dialect clustering}
\end{figure}
...
\label{fig:4}\is{dialect clustering}
\end{figure}
