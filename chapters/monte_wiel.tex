...
{\mdseries Caprese Michelangelo} & 0.1379 & 0.7931 & 0.7931\\
{\mdseries Pieve Santo Stefano} & 0.4000 & 0.7333 & 0.2000\\
{\mdseries Anghiari} & 0.0000 & 0.7059 & 1.0000\\
{\mdseries Sansepolcro} & 0.0000 & 1.0000 & 1.0000\\
\lspbottomrule
\end{tabular}
}
...
For what concerns the underlying lexical features, we first focus on the three main dialectal clusters (A, C and E). \tabref{tab:2} reports for each cluster the five most important CL pairs with associated values of representativeness, distinctiveness and importance.

The relevance of the lexical features with respect to the dialectal subdivision emerges clearly from the value maps in \figref{fig:2}, which show the geographic distribution of the first and second topmost lexical features of each of the three main identified clusters (A, C and E). The topmost lexical features associated with each identified cluster can be assimilated with the traditional notion of bundle of isoglosses, which have long been considered a major criterion for the definition of dialect areas: as \citet{chambers_dialectology_1998} put it, “the significance of a dialect area increases as more and more isoglosses are found which separate it from adjoining areas”.

\begin{table}
\resizebox{\textwidth}{!}{
\begin{tabular}{lp{.35\textwidth}p{.3\textwidth}p{.25\textwidth}p{.25\textwidth}p{.25\textwidth}}
\lsptoprule
{\bfseries Cluster} & {\bfseries Concept-Lexicalization pair} & {\bfseries Representativeness} & {\bfseries Distinctiveness} & {\bfseries Importance} \\
\midrule
{\mdseries E} & {\mdseries \textstyleBookTitle{\textmd{turkey}}{}-\emph{bìllo}} &  0.863 & 0.700 & 0.604 \\
& {\mdseries \textstyleBookTitle{\textmd{corner of tissue}}{}-\emph{pìnzo}} &  0.724 &  0.795 &  0.576 \\
& {\mdseries \textstyleBookTitle{\textmd{eye gum}}{}-\emph{cipìcchia}} &  0.624 &  0.920 &  0.574 \\
& {\mdseries \textstyleBookTitle{\textmd{oil jar}}{}-\emph{zìro}} &  0.879 &  0.609 &  0.535 \\
& {\mdseries \textstyleBookTitle{\textmd{vat}}{}-\emph{bigónzo}} &  0.649 &  0.821 &  0.533 \\
\midrule
{\mdseries A} & {\mdseries \textstyleBookTitle{\textmd{orange}}{}-\emph{arància}} &  0.779 &  0.675 &  0.526 \\
& {\mdseries \textstyleBookTitle{\textmd{ladle}}{}-\emph{romaiòlo}} &  0.788 &  0.536 &  0.423 \\
& {\mdseries \textstyleBookTitle{\textmd{oil jar}}{}-\emph{órcio}} &  0.671 &  0.590 &  0.396 \\
& {\mdseries \textstyleBookTitle{\textmd{turkey}}{}-\emph{tàcco}} &  0.390 &  1.000 &  0.390 \\
& {\mdseries \textstyleBookTitle{\textmd{brawn}}{}-\emph{capofréddo}} &  0.432 &  0.900 &  0.389 \\
\midrule
{\mdseries C} & {\mdseries \textstyleBookTitle{\textmd{oil jar}}{}-\emph{cóppo}} &  0.749 &  0.696 &  0.522 \\
& {\mdseries \textstyleBookTitle{\textmd{eye gum}}{}-\emph{cìspia}} &  0.702 &  0.676 &  0.474 \\
& {\mdseries \textstyleBookTitle{\textmd{breast}}{}-\emph{pùppa}} &  0.649 &  0.717 &  0.466 \\
& {\mdseries \textstyleBookTitle{\textmd{flea}}{}-\emph{pùce}} &  0.602 &  0.686 &  0.413 \\
& {\mdseries \textstyleBookTitle{\textmd{cluster of grapes}}{}-\emph{pìgna}} &  0.570 &  0.701 &  0.400 \\
\lspbottomrule
\end{tabular}
}
\caption{The five topmost lexical variants for the three main clusters of Tuscan dialects.}
\label{tab:2}
\end{table}

By comparing the maps of \figref{fig:2}, we can observe that the geographic distribution of the topmost CL pairs of the E, A and C clusters does not cover all and only the locations in the cluster. Each of them can be seen as a quantitative visualization of individual isoglosses, where darkness of color denotes the frequency of occurrence of the represented lexical variant (dark colors denote a greater frequency, lighter colors lower frequency, and no coloring indicates the absence of the variant). As can be observed, lexical variants shown in \tabref{tab:2} may occur beyond the border of the cluster area, thus lowering the distinctiveness value of the CL pair, or they may not occur in the whole cluster area resulting in a lower representativeness. For instance, in cluster A comparable representativeness values are observed for the two topmost CL pairs (0.77 - 0.78), whereas the CL ranked in second place, i.e. \textsc{ladle}{}-\textit{romaiòlo}, has a lower distinctiveness value (0.53) than the topmost CL (i.e. whose distinctiveness value is 0.67). Different patterns can be observed in clusters E and C, with decreasing representativeness and increasing distinctiveness in the former case, and with both of them decreasing in the latter case. Despite these slight differences, in all cases representativeness and distinctiveness show relatively high values which never reach the value of 1 (with the only exception of the CL pair \textsc{turkey}{}-\textit{tàcco} in cluster A whose distinctiveness is equal to 1). The average values of the five topmost lexical features for representativeness and distinctiveness range between 0.61 and 0.74, and 0.69 and 0.77 respectively, demonstrating that the corresponding dialect areas are not marked by very clear and strong dialect borders. 
...
{\bfseries Cluster} & {\bfseries Concept-Lexicalization pair} &  {\bfseries Representativeness} &  {\bfseries Distinctiveness} &  {\bfseries Importance}\\
\midrule
{\mdseries F} & {\mdseries \textstylehps{\textsc{finch}}{}-\textit{frenguéllo}} &  1.000 &  1.000 &  1.000\\
& {\mdseries \textstylehps{\textsc{cucumber}}{}-\textit{citróne}} &  1.000 &  0.973 &  0.973\\
& {\mdseries \textstylehps{\textsc{hail}}{}-\textit{granìschia}} &  0.667 &  1.000 &  0.667\\
& {\mdseries \textstylehps{\textsc{goose}}{}-\textit{ciucióne}} &  0.667 &  1.000 &  0.667\\
& {\mdseries \textstylehps{\textsc{lizard}}{}-\textit{racanàccio}} &  0.667 &  1.000 &  0.667\\
\midrule
{\mdseries B} & {\mdseries \textstylehps{\textsc{snow}}\textstyleatn{{}-}\textit{gnéva}} &  0.429 &  1.000 &  0.429\\
& {\mdseries \textstylehps{\textsc{rolling pin}}\textstyleatn{{}-}\textit{canèlla}\textstyleBookTitle{\textmd{ }}} &  0.429 &  1.000 &  0.429\\
& {\mdseries \textstylehps{\textsc{stye}}\textstylehps{{}-}\textit{orzaiolo}\textstyleBookTitle{\textmd{ }}} &  0.653 &  0.633 &  0.414\\
& {\mdseries \textstylehps{\textsc{garbage}}\textstyleatn{{}-}\textit{rùsco}\textstyleBookTitle{\textmd{ }}} &  0.531 &  0.734 &  0.389\\
& {\mdseries \textstylehps{\textsc{lizard}}\textstyleatn{{}-}\textit{ciortellóne}} &  0.430 &  0.853 &  0.367\\
\midrule
{\mdseries D} & {\mdseries \textstylehps{\textsc{hornet-}}\textit{buffóne}\textstyleBookTitle{\textmd{\textup{ }}}} &  0.950 &  1.000 &  0.950\\
& {\mdseries \textstylehps{\textsc{khakis}}\textstyleBookTitle{\textmd{\textup{{}-}}}\textit{cicàchi}} &  0.500 &  1.000 &  0.500\\
& {\mdseries \textstylehps{\textsc{khakis}}\textstyleBookTitle{\textmd{\textup{{}-}}}\textit{cicàco}} &  0.500 &  1.000 &  0.500\\
& {\mdseries \textstylehps{\textsc{pine cone}}\textstyleBookTitle{\textmd{\textup{{}-}}}\textit{pignòcca}\textstyleBookTitle{\textmd{\textup{ }}}} &  0.500 &  1.000 &  0.500\\
...
\figref{fig:3} reports the geographic visualization of clustering the Tuscan varieties into two, four and seven groups. In the map with two clusters (\figref{fig:3}, left), the large red cluster corresponds to the composite set of Tuscan dialects, excluding only the Chiana Valley dialects (cyan cluster). The map with four clusters (\figref{fig:3}, middle) shows the main subdivision of Tuscan dialects between Northern dialects (cyan and green clusters), covering (from east to west) Fiorentino, Pistoiese, Lucchese and Pisano-Livornese, and Southern dialects (violet and red clusters), i.e. (from east to west) the dialect from Arezzo, Siena and Grosseto (violet cluster) and from the Chiana valley (red cluster). The map containing seven clusters (\figref{fig:3}, right) has already been discussed above. 
...
\lsptoprule
{\bfseries Cluster} & {\bfseries Concept-Lexicalization pair} &  {\bfseries Representativeness} &  {\bfseries Distinctiveness} &  {\bfseries Importance}\\
Two-cluster map: Red & \textstyleBookTitle{\textmd{sink}}\textstyleBookTitle{{}-}\emph{acquàio} &  0.909 &  1.000 &  0.909\\
& {\mdseries \textstyleBookTitle{\textmd{celery}}\textstyleBookTitle{{}-}\emph{sèdano}} &  0.853 &  1.000 &  0.853\\
& {\mdseries \textstyleBookTitle{\textmd{melon}}\textstyleBookTitle{{}-}\emph{popóne}} &  0.844 &  1.000 &  0.844\\
& {\mdseries \textstyleBookTitle{\textmd{laurel}}\textstyleBookTitle{{}-}\emph{allòro}} &  0.801 &  1.000 &  0.801\\
& {\mdseries \textstyleBookTitle{\textmd{watermelon}}\textstyleBookTitle{{}-}\emph{cocómero}} &  0.794 &  1.000 &  0.794\\
\midrule
{\mdseries Four-cluster map:} {\mdseries Cyan} & {\mdseries \textstyleBookTitle{\textmd{thimble}}\textstyleBookTitle{{}-}\emph{anèllo}} &  0.495 &  0.857 &  0.424\\
& {\mdseries \textstyleBookTitle{\textmd{oil}}\textstyleBookTitle{ }\textstyleBookTitle{\textmd{jar}}{}-\emph{cóppo}} &  0.525 &  0.808 &  0.424\\
& {\mdseries \textstyleBookTitle{\textmd{caterpillar}}\textstyleBookTitle{{}-}\emph{brùcio}} &  0.448 &  0.928 &  0.416\\
& {\mdseries \textstyleBookTitle{\textmd{eye}}\textstyleBookTitle{ }\textstyleBookTitle{\textmd{gum}}{}-\emph{cìspia}} &  0.498 &  0.798 &  0.397\\
& {\mdseries \textstyleBookTitle{\textmd{turkey}}\textstyleBookTitle{{}-}\emph{lùcio}} &  0.445 &  0.872 &  0.388\\
\midrule
{\mdseries Seven-cluster map:} {\mdseries Blue} & {\mdseries \textstyleBookTitle{\textmd{oil}}\textstyleBookTitle{ }\textstyleBookTitle{\textmd{jar}}{}-\emph{cóppo}} &  0.749 &  0.696  &  0.522 \\
& {\mdseries \textstyleBookTitle{\textmd{eye}}\textstyleBookTitle{ }\textstyleBookTitle{\textmd{gum}}{}-\emph{cìspia}} &  0.702  &  0.676  &  0.474 \\
& {\mdseries \textstyleBookTitle{\textmd{breast}}{}-\emph{pùppa}} &  0.649  &  0.717  &  0.466 \\
& {\mdseries \textstyleBookTitle{\textmd{flea}}{}-\emph{pùce}} &  0.602  &  0.686  &  0.413 \\
...
The hierarchical spectral partitioning method can also be used for studying the dynamics of lexical change across generations. For this purpose, ALT speakers were grouped in an old age group (born in 1930 or earlier – 1930 was the median year of birth) and a young age group (born after 1930). To guarantee comparability of results, we focused on two maps each having four clusters. As \figref{fig:4} shows, the analysis of the two datasets results in slightly different, partially overlapping lexical areas, with the area corresponding to the southeastern (cyan) cluster being more restricted for the older speakers. Major differences, however, are explicitly clear at the level of the underlying lexical features. In particular, the central blue area is more restricted (and also linked with fewer CL pairs: 881 vs. 1193) in the map built on the basis of the answers by the young speakers. 
...
\begin{table}
\resizebox{\textwidth}{!}{
\begin{tabular}{p{.25\textwidth}p{.35\textwidth}p{.3\textwidth}p{.25\textwidth}p{.25\textwidth}p{.25\textwidth}}
\lsptoprule
{\bfseries Cluster} & {\bfseries Concept-Lexicalization pair} &  {\bfseries Representativeness} &  {\bfseries Distinctiveness} &  {\bfseries Importance}\\
\midrule
\multirow{2}{.25\textwidth}{Old speakers: Blue cluster} & \textstyleBookTitle{\textmd{grape}}{}-\emph{chìcco} &  0.721 &  0.828 &  0.597\\
& \textstyleBookTitle{\textmd{chestnut}}\textstyleBookTitle{ }\textstyleBookTitle{\textmd{husk}}{}-\emph{rìccio} &  0.706 &  0.661 &  0.467\\
& \textstyleBookTitle{\textmd{embers}}{}-\emph{bràce} &  0.673 &  0.632 &  0.425\\
& \textstyleBookTitle{\textmd{brazier}}{}-\emph{bracière} &  0.596 &  0.680 &  0.405\\
& \textstyleBookTitle{\textmd{hazelnut}}{}-\emph{nocciòla} &  0.794 &  0.507 &  0.403\\
\midrule
\multirow{2}{.25\textwidth}{Young speakers: Blue cluster} & \textstyleBookTitle{\textmd{bat}}{}-\emph{pipistrèllo} &  0.736 &  0.538 &  0.396\\
& \textstyleBookTitle{\textmd{breast}}{}-\emph{pùppa} &  0.428 &  0.900 &  0.385\\
& \textstyleBookTitle{\textmd{thimble}}{}-\emph{anèllo} &  0.394 &  0.893 &  0.352\\
& \textstyleBookTitle{\textmd{oil}}\textstyleBookTitle{ }\textstyleBookTitle{\textmd{jar}}{}-\emph{cóppo} &  0.437 &  0.772 &  0.337\\
& \textstyleBookTitle{\textmd{eye}}\textstyleBookTitle{ }\textstyleBookTitle{\textmd{gum}}{}-\emph{cìspia} &  0.431 &  0.779 &  0.335\\
\lspbottomrule
\end{tabular}
}
\caption{The five topmost lexical variants of the blue cluster in the young vs. old speakers maps of Tuscan dialects.}
\label{tab:5}
\end{table}
