...
{\mdseries Location} & {\mdseries \textsc{orange}{}-\textit{arància}} & {\mdseries \textsc{orange}{}-\textit{aràncio}} & {\mdseries \textsc{orange}{}-\textit{melàngola}}\\
\midrule
...
\begin{tabular}{lp{.35\textwidth}p{.3\textwidth}p{.25\textwidth}p{.25\textwidth}p{.25\textwidth}}
\lsptoprule
{\mdseries Cluster} & {\mdseries Concept-Lexicalization pair} &  {\mdseries Representativeness} &  {\mdseries Distinctiveness} &  {\mdseries Importance}\\
\midrule
...
{\mdseries Cluster} & {\mdseries Concept-Lexicalization pair} &  {\mdseries Representativeness} &  {\mdseries Distinctiveness} &  {\mdseries Importance}\\
\midrule
Two-cluster map: Red & \textstyleBookTitle{\textsc{sink}}\textstyleBookTitle{{}-}\emph{acquàio} &  0.909 &  1.000 &  0.909\\
& {\mdseries \textstyleBookTitle{\textsc{celery}}\textstyleBookTitle{{}-}\emph{sèdano}} &  0.853 &  1.000 &  0.853\\
& {\mdseries \textstyleBookTitle{\textsc{melon}}\textstyleBookTitle{{}-}\emph{popóne}} &  0.844 &  1.000 &  0.844\\
& {\mdseries \textstyleBookTitle{\textsc{laurel}}\textstyleBookTitle{{}-}\emph{allòro}} &  0.801 &  1.000 &  0.801\\
& {\mdseries \textstyleBookTitle{\textsc{watermelon}}\textstyleBookTitle{{}-}\emph{cocómero}} &  0.794 &  1.000 &  0.794\\
\midrule
{\mdseries Four-cluster map:} {\mdseries Cyan} & {\mdseries \textstyleBookTitle{\textsc{thimble}}\textstyleBookTitle{{}-}\emph{anèllo}} &  0.495 &  0.857 &  0.424\\
& {\mdseries \textstyleBookTitle{\textsc{oil}}\textstyleBookTitle{ }\textstyleBookTitle{\textsc{jar}}{}-\emph{cóppo}} &  0.525 &  0.808 &  0.424\\
& {\mdseries \textstyleBookTitle{\textsc{caterpillar}}\textstyleBookTitle{{}-}\emph{brùcio}} &  0.448 &  0.928 &  0.416\\
& {\mdseries \textstyleBookTitle{\textsc{eye}}\textstyleBookTitle{ }\textstyleBookTitle{\textsc{gum}}{}-\emph{cìspia}} &  0.498 &  0.798 &  0.397\\
& {\mdseries \textstyleBookTitle{\textsc{turkey}}\textstyleBookTitle{{}-}\emph{lùcio}} &  0.445 &  0.872 &  0.388\\
\midrule
{\mdseries Seven-cluster map:} {\mdseries Blue} & {\mdseries \textstyleBookTitle{\textsc{oil}}\textstyleBookTitle{ }\textstyleBookTitle{\textsc{jar}}{}-\emph{cóppo}} &  0.749 &  0.696  &  0.522 \\
& {\mdseries \textstyleBookTitle{\textsc{eye}}\textstyleBookTitle{ }\textstyleBookTitle{\textsc{gum}}{}-\emph{cìspia}} &  0.702  &  0.676  &  0.474 \\
& {\mdseries \textstyleBookTitle{\textsc{breast}}{}-\emph{pùppa}} &  0.649  &  0.717  &  0.466 \\
...
{\mdseries Cluster} & {\mdseries Concept-Lexicalization pair} &  {\mdseries Representativeness} &  {\mdseries Distinctiveness} &  {\mdseries Importance}\\
\midrule
\multirow{2}{.25\textwidth}{Old speakers: Blue cluster} & \textstyleBookTitle{\textsc{grape}}{}-\emph{chìcco} &  0.721 &  0.828 &  0.597\\
...
\midrule
\multirow{2}{.25\textwidth}{Young speakers: Blue cluster} & \textstyleBookTitle{\textsc{bat}}{}-\emph{pipistrèllo} &  0.736 &  0.538 &  0.396\\
