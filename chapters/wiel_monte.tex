...
\caption{Clustering of \ili{Tuscan} dialects in seven groups. Left: based on full dataset. Right: based on trimmed dataset.}
...
\caption{Distance-based clustering of \ili{Tuscan} dialects in seven groups using Ward's method. Left: based on full dataset. Right: based on trimmed dataset.}
