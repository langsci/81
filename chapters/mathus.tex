...
Field worker isoglosses, then, are present in speech atlases\is{speech atlas|)} and are presented as ``real isoglosses{\textquotedbl} separating speech variants.
