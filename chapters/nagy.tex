...
At this point, we can conduct the same comparative exercise with Schneider’s five phases of new dialect formation, with the same unsatisfying lack of convergence in outcome. For this discussion, I refer numerically to the four types of markers laid out in Schneider’s (\citeyear[255]{schneider_dynamics_2003}) \tabref{tab:1}:  {(1) History and politics, (2) Identity construction, (3) Use/attitudes}, and { (4) Linguistic developments/structural effects.}
