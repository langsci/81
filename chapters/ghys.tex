...
& a & \multirow{2}{.4\textwidth}{Realisation verbal prefix {\textless}ge{\textgreater} in past participles} & {\tabitem}{\ghysvara}Deletion first consonant (1, n=107): [æ]daan, [ə]daan (‘done’)\\
& & & {\tabitem}{\ghysvard}Realisation first consonant (2, n=969): [ɣə]daan\\
& & & \\
\cline{3-4}
& & & \\
& & \multirow{2}{.4\textwidth}{Representation Standard Dutch [s$\chi $] in anlaut} & 
{\tabitem}{\ghysvara} [ʃ$\chi $] (3, n=122): [ʃ$\chi $oːlə] (‘school’)\\
& & & {\tabitem}{\ghysvard}[s$\chi $] (4, n =154): [s$\chi $oːl]\\
& & & \\
\cline{2-4}
& & & \\
& b & \multirow{2}{.4\textwidth}{Representation Standard Dutch [ɛ.i] (not before r or in auslautposition)} 
& {\tabitem}{\ghysvara}Short monophthong (5, n=978): [mɪn] (‘mine’)\\
& & & {\tabitem}{\ghysvard}Long monophthong or diphthong\footnote{No distinction was made between the long monophthong [ɛː] and the dipthong [ɛ.i], nor between closed and open variants of the diphthongs. Without acoustic analyses, those distinctions proved too difficult to make objectively (Cohen’s kappa {\textless}0.61).} (6, n=1183): [mɛːn], m[ɛ.i]n\\
& & & \\
\cline{3-4}
& & & \\
& & \multirow{2}{.4\textwidth}{Representation Standard Dutch [œ.y] ({\textgreater} wgm. û)} & 
{\tabitem}{\ghysvara}Short monophthong (7, n=370): [hys] (‘house’) \\
& & & {\tabitem{\ghysvarc}}Long monophthong (8, n=340): [hœ.s]\\
& & & {\tabitem}{\ghysvard}Diphthong\footnote{For this variable and also for the realisation of Standard Dutch [ɔ.u] the distinction between long monophthongs and diphthongs proved objectively analysable without acoustic analysis (Cohens’s kappa {\textgreater}0.61); no distinction was however made between different degrees of openness in the realisation of these vowels, as these were too difficult to make without acoustic analyses.} (9, n=227): [hœ.ys]\\
& & & \\
\cline{3-4}
& & & \\
& & \multirow{2}{.4\textwidth}{Representation Standard Dutch [ɔ.u] before [t] of [d]} & 
{\tabitem}{\ghysvara}Short monophthong (10, n=116): [kut] (‘cold’) \\
& & & {\tabitem}{\ghysvarc}Long monophthong (11, n=44): [kɔːt]\\
& & & {\tabitem}{\ghysvard}Diphthong (12, n=95): [kɔ.ut] 
\\
& & & \\
\cline{3-4}
& & & \\
& & \multirow{2}{.4\textwidth}{Representation Standard Dutch [oː]({\textgreater} ogm. au) before dental consonant} & 
{\tabitem}{\ghysvara}Diphthong\footnote{In some areas of the research area, the diphthong is a typical feature of the dialect; in the city centre of Ypres, however, the basilectal form is the long monophthong which also characterises the standard language.} (13, n=87): [ɣruət] (‘big’) \\
...
& c & \multirow{2}{.4\textwidth}{Representation Standard Dutch [ɣ]}
& 
{\tabitem}{\ghysvara}Laryngalisation (15, n=4533): [h]oed [h]edaan (‘well done’) \\
& & & {\tabitem}{\ghysvard} [ɣ] (16, n=1109): [ɣ]oed [ɣ]edaan\\
& & & \\
\cline{3-4}
& & & \\
& & \multirow{2}{.4\textwidth}{Preservation of non-suffixal final schwa} & 
{\tabitem}{\ghysvara}Variant with schwa (17, n=105): \textit{bedde} (‘bed’) \\
& & & {\tabitem}{\ghysvard}Variant without schwa (18, n=168): \textit{bed} \\
& & & \\
\cline{3-4}
& & & \\
& & \multirow{2}{.4\textwidth}{Representation Standard Dutch [oː]
 ({\textgreater} wgm û in open syllables)} & 
{\tabitem}{\ghysvara}Palatalised form (19, n=95): [zønə] 
(‘son’) \\
& & &
{\tabitem}{\ghysvard}[oː] (20, n=115): [zoːn]\\
& & & \\
\cline{2-4}
& & & \\
%\lspbottomrule
...
{\tabitem}{\ghysvara}\textit{e} (27, n=426): \textit{e vent} (‘a guy’)\\
& & & {\tabitem}{\ghysvarc}\textit{ne }(28, n=120): \textit{ne vent}\\  
& & & {\tabitem}{\ghysvard}\textit{een} (29, n=109): \textit{een vent} \\
& & & \\
\cline{3-4}
& & & \\
& & \multirow{3}{.4\textwidth}{Verb form present simple 1st singular (in sentences without inversion)} & 
{\tabitem}{\ghysvara}Infinitive\footnote{This infinitive form is widespread in Flanders in a few historically athematic monosyllabic verbs (a.o. \textit{doen} ‘do’ and \textit{gaan} ‘go’), but the occurrence of the infinitive form in thematic verbs is confined to a small area in West Flanders. The variable was studied in all thematic verbs occurring in the first person singular.} (30, n=493): \textit{ik spelen} (‘I play’)\\
& & & {\tabitem{\ghysvarc}}root +e (31, n=34): \textit{ik spele}\\
& & & {\tabitem}{\ghysvard}root (32, n=266): \textit{ik speel}\\
& & & \\
\cline{3-4}
& & & \\
& & \multirow{2}{.4\textwidth}{Possessive pronoun 1st plural form of pronoun} & 
{\tabitem}{\ghysvara}\textit{(n)us/(n)uze} (33, n=77): \textit{(n)us kind, (n)uze moeder} (‘our child’, ‘our mother’) \\
& & & {\tabitem}{\ghysvard}\textit{ons/onze} (34, n=145): \textit{ons kind, onze moeder} \\
& & & \\
%%%
...
& & & \\
\multirow{2}{.05\textwidth}{\rotatebox[origin=r]{90}{Morpho-Syntax}}
& c & \multirow{3}{.4\textwidth}{Subject doubling: 3rd singular mascular/feminine, 1st plural, 3rd plural in sentences with inversion and dependent clauses, with a full subject\footnote{In these cases subject doubling with a weak pronoun is obligatory in the local dialect (cf. \citealt[326]{de_vogelaer_nederlandse_2008}).}} & 
{\tabitem}{\ghysvara}Subject doubling (42, n=80): \textit{A me wider komen}… (Lit: ‘if we come’)\\ 
& & & {\tabitem}{\ghysvard}No subject doubling (43, n=204): \textit{Als wij komen}... (Lit: ‘if we come’)\\
& & & \\
& & & \\
\cline{3-4}
& & & \\
& & \multirow{2}{.4\textwidth}{Auxiliary in present perfect with \textit{zijn} (‘to be’), \textit{tegenkomen} (‘meet’) and \textit{vallen} (‘fall’) as main verbs} & 
{\tabitem}{\ghysvara}\textit{hebben} (44, n=27): \textit{Ik heb ziek geweest}. (Lit: ‘I have ill been’) \\
& & & {\tabitem}{\ghysvard}\textit{zijn} (45, n=113): \textit{Ik ben ziek geweest} (Lit: ‘I am ill been’)\\
...
& & & \\
\multirow{2}{.05\textwidth}{\rotatebox[origin=r]{90}{Morpho-Syntax}}
& e & \multirow{2}{.4\textwidth}{Personal pronoun 2nd singular, weak form in preverbal position} & 
{\tabitem}{\ghysvarc}\textit{ge} (52, n=153): \textit{Ge komt.} (‘you are coming’)\\ 
& & & {\tabitem}{\ghysvarb}\textit{je} (53, n=321): \textit{Je komt.} \\
& & & {\tabitem}{\ghysvara}\textit{je...gie} (54, n=15): \textit{Je komt gie.} \\
& & & \\
\cline{3-4}
& & & \\
& & \multirow{2}{.4\textwidth}{Diminutives with nouns of which the root does not end in [t]} & 
{\tabitem}{\ghysvarc}\textit{ke}{}-diminutive (55, n=55): \textit{bloemke/bloemeke} (‘little flower’)\\ 
& & & {\tabitem}{\ghysvarb}\textit{je}{}-diminutive\footnote{The allomorphy within the \textit{je}-suffix was not taken into account as this complicates the calculation of distance measures: some of the \textit{je}-suffixes in the Ypres dialect coincide for instance with Standard Dutch \textit{je}-suffixes (\textit{bloemetje}, ‘little flower’), whereas others have a different allomorph (\textit{boeksje} versus \textit{boekje}, ‘little book’).} (56, n=169): \textit{b}\textit{loempje}\\
& & & \\
\cline{3-4}
& & & \\
& & \multirow{2}{.4\textwidth}{Negation in sentences with \textit{nooit} (‘never’), \textit{niemand} (‘no one’), \textit{nergens} (‘nowhere’)} & 
{\tabitem}{\ghysvarc}Double negation (57, n=3): \textit{Ik ga dat nooit nie doen}. (Lit: ‘I go that never never do’)\\ 
& & & {\tabitem}{\ghysvarb}Single negation (58, n=103): \textit{Ik ga dat nooit doen}. (Lit: ‘I go that never do’)\\
& & & \\
\cline{3-4}
& & & \\
& & \multirow{2}{.4\textwidth}{Possessive pronoun 1st plural inflection before female singular nouns, male singular nouns referring to a family relationship, or before plural nouns} & 
{\tabitem}{\ghysvarc}No inflection (59, n=18): \textit{ons moeder} (‘our mother’)\\ 
& & & {\tabitem}{\ghysvarb}With inflection (60, n=37): \textit{onze moeder}\\
& & & \\
& & & \\
& & & \\
& & & \\
