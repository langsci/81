...
\cline{3-4}
\\
& & \multirow{2}{3.5cm}{Diminutives with nouns of which the root does not end in [t]} & 
...
\cline{3-4}
\\
& & \multirow{2}{3.5cm}{Negation in sentences with \textit{nooit} (‘never’), \textit{niemand} (‘no one’), \textit{nergens} (‘nowhere’)} & 
...
\cline{3-4}
\\
& & \multirow{2}{3.5cm}{Possessive pronoun 1st plural inflection before female singular nouns, male singular nouns referring to a family relationship, or before plural nouns} & 
