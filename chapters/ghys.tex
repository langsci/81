...
& a & \multirow{2}{.4\textwidth}{Realisation verbal prefix {\textless}ge{\textgreater} in past participles} & {\tabitem}{\ghysvara}Deletion first consonant (1, n=107): [æ]daan, %[ə]
daan (‘done’)\\
& & & {\tabitem}{\ghysvard}Realisation first consonant (2, n=969): %[ɣə]
daan\\
& & & \\
\cline{3-4}
& & & \\
& & \multirow{2}{.4\textwidth}{Representation Standard Dutch [s$\chi $] in anlaut} & 
{\tabitem}{\ghysvara} %[ʃ$\chi $] 
(3, n=122): %[ʃ$\chi $oːlə] 
(‘school’)\\
& & & {\tabitem}{\ghysvard}[s$\chi $] (4, n =155): %[s$\chi $oːl]
\\
& & & \\
\cline{2-4}
& & & \\
 & b & \multirow{2}{.4\textwidth}{Representation Standard Dutch 
%[ɛ.i]
(not before r or in auslautposition)} & {\tabitem}{\ghysvara}Short monophthong (5, n=978): 
%[mɪn]
('mine') \\
& & & {\tabitem}{\ghysvard}Long monophthong or diphthong\footnote{No distinction was made between the long monophthong %[ɛː]
and the dipthong %[ɛ.i],
nor between closed and open variants of the diphthongs. Without acoustic analyses, those distinctions proved too difficult to make objectively (Cohen’s kappa {\textless}0.61).} (6, n=1183): 
%[mɛːn], m[ɛ.i]n 
\\
& & & \\
\cline{3-4}
...
& & & {\tabitem{\ghysvarc}}Long monophthong (8, n=340): 
%[hœ.s]
\\
& & & {\tabitem}{\ghysvard}Diphthong\footnote{For this variable and also for the realisation of Standard Dutch %[ɔ.u]
...
& c & \multirow{2}{.4\textwidth}{Representation Standard Dutch 
 %[ɣ]
 }
 & 
{\tabitem}{\ghysvara}Laryngalisation (15, n=4533): [h]oed [h]edaan ('well done') %[ɣ] 
\\
& & & {\tabitem}{\ghysvard}(16, n=1109): 
%[ɣ]
oed 
%[ɣ]
edaan\\
...
{\tabitem}{\ghysvara}Infinitive\footnote{This infinitive form is widespread in Flanders in a few monosyllabic verbs (a.o. \textit{doen} 'do' and \textit{gaan} 'go'), but the occurrence of the infinitive form in almost all verbs is confined to a small area in West Flanders. The variable was studied in all verbs occurring in the first person singular.} (30, n=628): \textit{ik spelen} ('I play')\\
& & & {\tabitem{\ghysvarc}}root +e (31, n=93): \textit{ik spele}\\
& & & {\tabitem}{\ghysvard}root (32, n=1038): \textit{ik speel}\\
& & & \\
\cline{3-4}
& & & \\
...
{\tabitem}{\ghysvara}\textit{ne/e} (35, n=82): \textit{Ne komt ook}. ('he is coming too')\\ 
...
{\tabitem}{\ghysvara}Subject doubling (45, n=80): \textit{A me wider komen}… (Lit: 'if we we come')\\ 
& & & {\tabitem}{\ghysvard}No subject doubling (46, n=204): \textit{Als wij komen}... (Lit: 'if we come')\\
& & & \\
& & & \\
\cline{3-4}
& & & \\
...
{\tabitem}{\ghysvara}\textit{hebben} (47, n=27): \textit{Ik heb ziek geweest}. (Lit: 'I have ill been') \\
& & & {\tabitem}{\ghysvard}\textit{zijn} (48, n=113): \textit{Ik ben ziek geweest} (Lit: 'I am ill been')\\
...
& & & \\
\multirow{2}{.05\textwidth}{\rotatebox[origin=r]{90}{Morpho-Syntax}}
& e & \multirow{2}{.4\textwidth}{Personal pronoun 2nd singular, weak form} & 
{\tabitem}{\ghysvarc}\textit{ge/de} (55, n=304): \textit{Ge komt.} ('you are coming')\\ 
& & & {\tabitem}{\ghysvarb}\textit{je} (56, n=1138): \textit{Je komt.} \\
& & & \\
\cline{3-4}
& & & \\
& & \multirow{2}{.4\textwidth}{Diminutives with nouns of which the root does not end in [t]} & 
{\tabitem}{\ghysvarc}\textit{ke}{}-diminutive (57, n=55): \textit{bloemke/bloemeke} ('little flower')\\ 
& & & {\tabitem}{\ghysvarb}\textit{je}{}-diminutive\footnote{The allomorphy within the je-suffix was not taken into account as this complicates the calculation of distance measures: some of the je-suffixes in the Ypres dialect coincide for instance with Standard Dutch je-suffixes (\textit{bloemetje}, ‘little flower’), whereas others have a different allomorph (\textit{boeksje} versus \textit{boekje}, ‘little book’).} (58, n=169): \textit{b}\textit{loempje}\\
& & & \\
\cline{3-4}
& & & \\
& & \multirow{2}{.4\textwidth}{Negation in sentences with \textit{nooit} ('never'), \textit{niemand} ('no one'), \textit{nergens} ('nowhere')} & 
{\tabitem}{\ghysvarc}Double negation (59, n=3): \textit{Ik ga dat nooit nie doen}. (Lit: 'I go that never never do')\\ 
& & & {\tabitem}{\ghysvarb}Single negation (60, n=103): \textit{Ik ga dat nooit doen}. (Lit: 'I go that never do')\\
& & & \\
\cline{3-4}
& & & \\
...
{\tabitem}{\ghysvarc}No inflection (61, n=18): \textit{ons moeder} ('our mother')\\ 
& & & {\tabitem}{\ghysvarb}With inflection (62, n=37): \textit{onze moeder}\\
& & & \\
& & & \\
& & & \\
& & & \\
...
On the basis of \figref{fig:2}, it is possible to suggest that the language repertoire in Ypres is of a diaglossic nature, stretching from dialect to standard language, with a range of intermediate variations. However, as argued in §3, the personal repertoires of the individual speakers need to be studied first, as the overall diaglossic image might result from a combination of mainly diglossic personal repertoires, each comprising slightly different language codes.
