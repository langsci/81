...
a & \multirow{2}{3.5cm}{Realisation verbal prefix {\textless}ge{\textgreater} in past participles} &
...
\\ 
& \multirow{2}{3.5cm}{Representation Standard Dutch [s$\chi $] in anlaut} & 
{\tabitem}{\ghysvara} [ʃ$\chi $] (3, n=122): [ʃ$\chi $oːlə] (‘school’)\\
& & {\tabitem}{\ghysvard}[s$\chi $] (4, n =154): [s$\chi $oːl]\\
\\
\midrule
\\
b & \multirow{2}{3.5cm}{Representation Standard Dutch [ɛ.i] (not before r or in auslautposition)} 
& 
\parbox{8.5cm}{{\tabitem}{\ghysvara}Short monophthong (5, n=978): [mɪn] (‘mine’)}\\
& & 
\parbox{8.5cm}{{\tabitem}{\ghysvard}Long monophthong or diphthong\footnote{No distinction was made between the long monophthong [ɛː] and the dipthong [ɛ.i], nor between closed and open variants of the diphthongs. Without acoustic analyses, those distinctions proved too difficult to make objectively (Cohen’s kappa {\textless}0.61).} (6, n=1183): [mɛːn], m[ɛ.i]n}\\
\\ 
& \multirow{2}{3.5cm}{Representation Standard Dutch [œ.y] ({\textgreater} wgm. û)} & 
\parbox{8.5cm}{{\tabitem}{\ghysvara}Short monophthong (7, n=370): [hys] (‘house’)}\\
& & 
\parbox{8.5cm}{{\tabitem{\ghysvarc}}Long monophthong (8, n=340): [hœ.s]}\\
& & 
\parbox{8.5cm}{{\tabitem}{\ghysvard}Diphthong\footnote{For this variable and also for the realisation of Standard Dutch [ɔ.u] the distinction between long monophthongs and diphthongs proved objectively analysable without acoustic analysis (Cohens’s kappa {\textgreater}0.61); no distinction was however made between different degrees of openness in the realisation of these vowels, as these were too difficult to make without acoustic analyses.} (9, n=227): [hœ.ys]}\\
\\ 
& \multirow{2}{3.5cm}{Representation Standard Dutch [ɔ.u] before [t] of [d]} & 
\parbox{8.5cm}{{\tabitem}{\ghysvara}Short monophthong (10, n=116): [kut] (‘cold’)}\\
& & 
\parbox{8.5cm}{{\tabitem}{\ghysvarc}Long monophthong (11, n=44): [kɔːt]}\\
& & 
\parbox{8.5cm}{{\tabitem}{\ghysvard}Diphthong (12, n=95): [kɔ.ut]} 
\\ 
\\
& \multirow{2}{3.5cm}{Representation Standard Dutch [oː]({\textgreater} ogm. au) before dental consonant} & 
...
\resizebox{\textwidth}{!}{
\begin{tabular}{lp{.4\textwidth}p{.6\textwidth}} 
Region & Variable & Attested variants (variant number, variant frequency)\\
\lsptoprule
\\
