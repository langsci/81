...
\begin{tikzpicture}
	...
	\node	[align=center,draw,rounded corners=.25cm,inner sep=20pt] (trans) at (3,3) {`A thick wooden post\\around which a mooring\\rope is tied.'};
...
\begin{tikzpicture}
	...
	\node	[align=center,draw,minimum width=4cm,rounded corners=.25cm,inner sep=20pt] (trans) at (3,3) {`Something on a\\boat?'};
	\node	[below left = 2.5cm of trans,draw] (native) at (2,0) {\itshape\textbf{manku(l)} m.};
	\node	[below right = 2.5cm of trans,inner sep=0pt,outer sep=0pt] (image) at (4,0) {\usebox\MooringRope};
...
\begin{tikzpicture}
	...
	\node	[align=center,draw,rounded corners=.25cm,inner sep=20pt] (trans) at (3,3) {`A type of a fishing tool\\used to collect different kinds\\of seashells by dragging it\\across the sea floor.'};
...
\begin{tikzpicture}
	...
	\node	[align=center,draw,rounded corners=.25cm,inner sep=20pt] (trans) at (3,3) {`A net used for\\collecting seashells.'};
	\node	[below left = 2.5cm of trans,draw] (native) at (2,0) {\itshape\textbf{brganja} f.};
